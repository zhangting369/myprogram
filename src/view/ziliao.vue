        ...
        <el-container>
          <el-aside width="90%" style="margin: 40px auto;">
            <el-tabs :tab-position="tabPosition">
                    ...
                    <el-tab-pane label="地址管理" name="first">
                      <div class="ziliao_write">
                        <div class="ziliao_write1">
                          <p class="chuangjian">你已创建 0 个收货地址，最多可以创建 10 个</p>&nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;如需要修改订单配送地址，请前往【我的订单】
                        ...
                        <el-dialog title="收货地址" :visible.sync="dialogFormVisible">
                          <el-form :model="address" style="widtn:100%;">
                            <el-form-item label="用户名" :label-width="formLabelWidth">
                              <el-input v-model="address.name" autocomplete="off"></el-input>
                            </el-form-item>
                            <el-form-item label="地址" :label-width="formLabelWidth">
                              <el-input v-model="address.address1" autocomplete="off"></el-input>
                            </el-form-item>
                            <el-form-item label="详细地址" :label-width="formLabelWidth">
                              <el-input v-model="address.address2" autocomplete="off"></el-input>
                            </el-form-item>
                          ...
                          <div slot="footer" class="dialog-footer">
                            ...
                            <el-button type="primary" @click="getaddaddress()">确 定</el-button>
                          </div>
                        </el-dialog>
                      </div>
                      ...
                      <el-table
                        :data="tableData"
                        style="width: 100%;margin-top:20px;background-color:#f5f5f5;"
                      >
                        ...
                        <el-table-column label>
                          <template slot-scope="scope">
                            <el-button size="mini" @click="etditaddress1(scope.row.shipping_id)">编辑</el-button>
                            <!-- <el-button type="text" @click="dialogFormVisible1 = true">打开嵌套表单的 Dialog</el-button> -->
                           
                            <el-dialog title="编辑地址" :visible.sync="dialogFormVisible1">
                              <el-form :model="editaddress" >
                                <!-- <div v-for="(item,i) in addlist" :key="i"> -->
                                <el-form-item label="用户名" :label-width="formLabelWidth">
                                  <el-input  v-model="editaddress.name" value="item.receiver_name" autocomplete="off"></el-input>
                                </el-form-item>
                                 <el-form-item label="地址" :label-width="formLabelWidth">
                                  <el-input v-model="editaddress.address1" value="item.receiver_address" autocomplete="off"></el-input>
                                </el-form-item>
                                 <el-form-item label="详细地址" :label-width="formLabelWidth">
                                  <el-input v-model="editaddress.address2" value="item.receiver_province" autocomplete="off"></el-input>
                                </el-form-item>
                                 <el-form-item label="手机号码" :label-width="formLabelWidth">
                                  <el-input v-model="editaddress.phone" value="item.receiver_mobile" autocomplete="off"></el-input>
                                </el-form-item>
                                <!-- </div> -->
                              </el-form>
                              <div slot="footer" class="dialog-footer">
                                <el-button @click="dialogFormVisible1 = false">取 消</el-button>
                                <el-button type="primary" @click="etditaddress(scope.row.shipping_id)">保存编辑</el-button>
                              </div>
                            </el-dialog>
                            ...
                            <el-button
                              size="mini"
                              type="danger"
                              @click="getdeladdress(scope.row.shipping_id)"
                            >删除</el-button>
                          </template>
                        </el-table-column>
                      </el-table>
              ...
              <el-tab-pane class="ziliao_xin" label="资产中心" disabled>资产中心</el-tab-pane>
...
export default {
  ...
  data() {
    ...
    return {
      ...
      hao: "订单号：2019112017243327612280",
      math: "数学",
      monn: "700",
  ...
  methods: {
    ...
    etditaddress1(id2) {
      this.$http.get("/upi/shipping/" + id2).then(res => {
        // console.log(res);
    ...
    etditaddress(shoppingid) {
      console.log(shoppingid)
      let fromdata = new FormData();
      fromdata.append("receiver_name", this.editaddress.name);
      fromdata.append("receiver_province", this.editaddress.address1);
      fromdata.append("receiver_address", this.editaddress.address2);
      fromdata.append("shipping_id", shoppingid);
      fromdata.append("user_id", 1);
      fromdata.append("receiver_mobile", this.editaddress.phone);
    ...
    getaddaddress() {
      let fromdata = new FormData();
      fromdata.append("receiver_name", this.address.name);
      fromdata.append("receiver_province", this.address.address1);
      fromdata.append("receiver_address", this.address.address2);
      fromdata.append("user_id", 1);
      fromdata.append("receiver_mobile", this.address.phone);
      this.$http.post("/upi/shipping", fromdata).then(res => {
        console.log(res);
      });
    },
    getdeladdress(id2) {
      this.$http.delete("/upi/shipping/" + id2).then(res => {
        console.log(res);
        alert("确定删除吗")
      });
    },
